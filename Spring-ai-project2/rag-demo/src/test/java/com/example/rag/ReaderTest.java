...
public class ReaderTest {
    ...
    void testHTMLReader(@Value("classpath:file/my-page.html") Resource resource) {
        JsoupDocumentReaderConfig config = JsoupDocumentReaderConfig.builder()
                ...
                .additionalMetadata("source", "my-page.html").build();
    ...
    void testReadPDFpage() {
        PagePdfDocumentReader pdfReader = new
                PagePdfDocumentReader("classpath:/file/sample1.pdf",
    ...
    void testReadPDFParagrap() {
        ParagraphPdfDocumentReader pdfReader = new
                ParagraphPdfDocumentReader("classpath:file/sample-paragraph.pdf",
                PdfDocumentReaderConfig.builder()
